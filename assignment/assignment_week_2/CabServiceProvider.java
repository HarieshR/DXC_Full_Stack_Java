...
class CabServiceProviderDetails
{
	private String cabServiceName;
	private int totalCabs;
	
	public CabServiceProviderDetails(String cabServiceName, int toalCabs){
...
class CabServiceProvider {
	...
	public static void main(String args[]){
		CabServiceProviderDetails cabServiceProvider1 = new CabServiceProviderDetails("Halo", 50);
